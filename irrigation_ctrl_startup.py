...
if __name__ == "__main__":
   ...
   irrigation_io_control     = io_control_backup.irrigation_ctl.IrrigationControl( irrigation_io, main_valve_list, plc_map, redis )
...
#
   ...
   cf.define_chain("monitor_main_on_switch",False) #TBD
